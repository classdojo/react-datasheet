...
var DataSheet = function (_PureComponent) {
  ...
  _createClass(DataSheet, [{
    ...
    value: function onMouseDown(i, j) {
      ...
      var forceEdit = this.props.forceEditOnClick === true;

      this.setState({ selecting: true, start: { i: i, j: j }, end: { i: i, j: j }, editing: editing, forceEdit: forceEdit });
...
DataSheet.propTypes = {
  ...
  overrideEditingPaste: _propTypes2.default.bool,
  forceEditOnClick: _propTypes2.default.bool
};